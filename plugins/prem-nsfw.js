...
let solog = (ch == true ? false : false)
let lewdk = (ch == true ? false : true)
let lewd = (ch == true ? false : true)
let feetg = (ch == true ? false : true)
let ass = (ch == true ? false : true)
let blowjob = (ch == true ? false : true)
let cum = (ch == true ? false : true)
...
let erokemo = (ch == true ? false : false)
...
const sections = [
   {
	...
	{title: `${ solog == true ? p:f}` + "A • Solog", rowId: ".nsfw solog"},
	{title: `${ lewdk == true ? p:f}` + "C • Lewdk", rowId: ".nsfw lewdk"},
	{title: `${ lewd == true ? p:f}` + "C • Lewd", rowId: ".nsfw lewd"},
	{title: `${ feetg == true ? p:f}` + "C • Feetg", rowId: ".nsfw feetg"},
	//{title: `${ ass == true ? p:f}` + "A • Ass", rowId: ".nsfw ass"},
	{title: `${ blowjob == true ? p:f}` + "B • BlowJob", rowId: ".nsfw blowjob"},
	{title: `${ cum == true ? p:f}` + "C • Cum", rowId: ".nsfw cum"},
	...
	{title: `${ erokemo == true ? p:f}` + "E • Ero Kemo", rowId: ".nsfw erokemo"},
...
case 'lewdk':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(resl + 'lewdk' + apil)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
           break
...
case 'holoero':
	     ...
	     if (db.data.users[m.sender].premiumTime < 1) return conn.sendButton(m.chat, txtprem, botdate, [['ʙᴜʏ ᴘʀᴇᴍɪᴜᴍ', '.premium'],['ᴏᴡɴᴇʀ', '.owner nomor']], m)
          ...
          conn.sendButton(m.chat, tekk, fot, await(await fetch(res + 'holoero' + api)).buffer(), [[next, `${usedPrefix}nsfw ${args[0]}`]],m)
            break
